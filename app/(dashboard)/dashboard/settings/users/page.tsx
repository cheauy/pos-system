...
export default async function UsersPage({
  ...
  const {
    ...
    .from("businesses")
    .select("max_staff,subscription_team_enabled,subscription_plan_key,subscription_status")
    .eq("id", business.id)
    .maybeSingle();
  ...
  if (
    ...
    businessData.subscription_team_enabled === false
  ) {
    redirect("/dashboard/settings/subscription?upgrade=team");
  }
