...
export default function CategoryDisplayBranches({ branches, branchIds = null }: {
  ...
  return <fieldset ref={fieldset} className="space-y-3 rounded-xl border border-slate-200 p-3 text-sm">
