...
export default async function SubscriptionPaymentList() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-950 dark:text-white">Subscriptions</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[1100px] text-left">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {orders.length === 0 && <tr><td colSpan={7} className="px-5 py-12 text-center text-sm text-slate-500">No subscription payments to review.</td></tr>}
              {orders.map((order) => {
